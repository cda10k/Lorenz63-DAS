...
!----------------------------------------------------------------------------------
  ...
  kitermax_out = 4  ! maximum number of outer loop

  nsteps_per_da = 5    ! perform 4d-var every nsteps_per_da steps
  nsteps_da_window = 5 ! for each 4d-var cycle, use obs up to  nsteps_da_window steps
